...
router.post('/users/owner', controller.createOwner);
...
router.post('/users/party/create', controller.createParty);
...
router.get('/users/info/party/:email', controller.checkIfUserHasParty);

// given a partyId, deletes that party
// TODO: ADD SECURITY TO THIS THING! ONLY OWNER SHOULD BE ABLE TO DELETE
router.delete('/party', controller.deleteParty);

router.get('/party/:id', controller.checkIfPartyExists);
...
router.post('/party/upload', controller.insertUrlInDb);
...
router.get('/party/socketRoom/:id', controller.getSocketRoom);
